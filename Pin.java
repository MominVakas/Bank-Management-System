...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setFont(new Font("Liberation Serif", Font.BOLD, 18));
        l1.setForeground(Color.WHITE);
        
        l2 = new JLabel("New PIN:");
        l2.setFont(new Font("Liberation Serif", Font.BOLD, 18));
        l2.setForeground(Color.WHITE);
        
        l3 = new JLabel("Re-Enter New PIN:");
        l3.setFont(new Font("Liberation Serif", Font.BOLD, 18));
        l3.setForeground(Color.WHITE);
        
        t1 = new JPasswordField();
        t1.setFont(new Font("Liberation Serif", Font.BOLD, 26));
        
        t2 = new JPasswordField();
        t2.setFont(new Font("Liberation Serif", Font.BOLD, 26));
