...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        b = new JButton("Next");
        b.setFont(new Font("Liberation Serif", Font.BOLD, 22));
        b.setBackground(new Color(255, 204, 102));
        b.setForeground(new Color(0, 0, 0));
        
        t1 = new JTextField();
        t1.setFont(new Font("Liberation Serif", Font.BOLD, 14));
        
        t2 = new JTextField();
        t2.setFont(new Font("Liberation Serif", Font.BOLD, 14));
        ...
        c1.setFont(new Font("Liberation Serif", Font.BOLD, 15));
        
        String category[] = {"General","OBC","SC","ST","Other"};
        c2 = new JComboBox(category);
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Liberation Serif", Font.BOLD, 15));
        
        String income[] = {"Null","<1,50,000","<2,50,000","<5,00,000","Upto 10,00,000","Above 10,00,000"};
        c3 = new JComboBox(income);
        c3.setBackground(Color.WHITE);
        c3.setFont(new Font("Liberation Serif", Font.BOLD, 15));
        
        String education[] = {"Non-Graduate","Graduate","Post-Graduate","Doctrate","Others"};
        c4 = new JComboBox(education);
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Liberation Serif", Font.BOLD, 15));
        
        String occupation[] = {"Salaried","Self-Employmed","Business","Student","Retired","Others"};
        c5 = new JComboBox(occupation);
        c5.setBackground(Color.WHITE);
        c5.setFont(new Font("Liberation Serif", Font.BOLD, 15));
       
        
        getContentPane().setLayout(null);
        
        l1.setBounds(350,27,600,40);
